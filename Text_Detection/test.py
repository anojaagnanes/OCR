...
parser.add_argument('--test_folder', default='./Text_Detection/data', type=str, help='folder path to input images')
parser.add_argument('--refine', default=False, action='store_true', help='enable link refiner')
parser.add_argument('--refiner_model', default='./Text_Detection/weights/craft_refiner_CTW1500.pth', type=str,
